with _pr_stats as (
    ...
    WHERE
      ...
      and FROM_UNIXTIME(:from) <= cdc.finished_date
      and cdc.finished_date <= FROM_UNIXTIME(:to)
),
...
WHERE cm.month_timestamp > FROM_UNIXTIME(:from) AND cm.month_timestamp < FROM_UNIXTIME(:to)